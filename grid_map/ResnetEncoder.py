...
class ResnetEncoder(nn.Module):
    ...
    def __init__(self, num_layers, pretrained, num_input_images=1, if_front_encoder=True):
        ...
        self.front_encoder = if_front_encoder

    def forward(self, input_image):
        self.features = []
        if self.front_encoder:   
            ...
            x = input_image
            self.features.append(self.encoder.layer3(x))
